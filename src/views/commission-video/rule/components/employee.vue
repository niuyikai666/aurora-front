  ...
  <div class="pd24">
    ...
    >
      <span slot="action" slot-scope="text, record">
        <a-button type="link" @click="edit(record, record.commissionType.msg)" v-if="dealVisible(record.monthDate)">编辑</a-button>
      </span>
    </s-table>
    <employee-rule :id="id" :visible="visible" @cancel="cancel" :title="title"/>
  </div>
</template>

<script>
import employeeRule from './employeeRule'
