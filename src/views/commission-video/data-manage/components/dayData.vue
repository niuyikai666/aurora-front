...
<script>
import { importDayData } from '@/api/commission-video'
import importModal from './importModal'
import moment from 'moment'
import { mapGetters } from 'vuex'
import { STable } from '@/components'
import { dayDataColumns } from '../tableColumns'
export default {
  props: {
    fn: {
      type: Function,
  ...
  data () {
    return {
      ...
      errorUrl: process.env.VUE_APP_API_BASE_URL + '/wm/vd/exportErro',
      templateUrl: process.env.VUE_APP_API_BASE_URL + '/wm/vd/template',
      taskType: [{
        name: '拉新',
        value: 1
      }, {
  ...
  methods: {
    loadData (params) {
      Object.assign(params, {
        dateTime: this.monthDate || moment().format('YYYY-MM')
      }, this.queryParams)
