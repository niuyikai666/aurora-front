<template>
  <a-modal
    ...
    :destroyOnClose="true"
  >
    <div class="top-text mb14">请选择要反馈的<span class="red">{{ month }}</span>月结算运营关系：</div>
    <a-form :form="form" :label-col="{ span: 7 }" :wrapper-col="{ span: 15 }">
      <a-form-item label="结算运营人">
        <search-auth-employee
...
<script>
import searchAuthEmployee from './searchAuthEmployee'
