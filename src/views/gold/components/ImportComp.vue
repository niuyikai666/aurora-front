...
export default {
  ...
  data () {
    return {
      templateUrl: `${process.env.VUE_APP_API_BASE_URL}/afterGoldData/export/sign/template`,
      uploadUrl: `${process.env.VUE_APP_API_BASE_URL}/afterGoldData/upload/sign/operation`,
      errorDownUrl: '',
      loadding: false,
      success: false,
      fileInfo: {}
  ...
  methods: {
    ...
    handleChange (info) {
      ...
      if (status === 'done') {
        ...
        this.errorDownUrl = ''
        this.errorDownUrl = `${process.env.VUE_APP_API_BASE_URL}/afterGoldData/export/sign/fail/data?uploadCode=${info.file.response.uploadCode}`
