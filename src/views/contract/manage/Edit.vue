            ...
            <a-col :md="8">
              <a-form-item
                ...
                <a-select
                  ...
                  placeholder="请选择"
                >
                  <a-select-option v-for="(item, index) in templateType" :key="index" :value="parseInt(index)">
                    {{ item }}
                  </a-select-option>
                </a-select>
              </a-form-item>
            ...
            <a-col :md="8">
              <a-form-item
                ...
                <a-select
                  ...
                  placeholder="请选择"
                >
                  <a-select-option v-for="(item, index) in actorType" :key="index" :value="parseInt(index)">
                    {{ item }}
                  </a-select-option>
                </a-select>
              </a-form-item>
          ...
          <a-row :gutter="80">
            ...
            <a-col :md="8">
              <a-form-item
                ...
                <p v-if="contractIndexPageUrl" class="file-name">{{ subStr(contractIndexPageUrl) }}</p>
            ...
            <a-col :md="8">
              <a-form-item
                ...
                <p v-if="contractLastPageUrl" class="file-name">{{ subStr(contractLastPageUrl) }}</p>
            ...
            <a-col :md="8">
              <a-form-item
                ...
                <a-select
                  ...
                  placeholder="请选择"
                >
                  <a-select-option v-for="(item, index) in contractType" :key="index" :value="parseInt(index)">
                    {{ item }}
                  </a-select-option>
                </a-select>
              </a-form-item>
...
import { contractEdit, contractDetail } from '@/api/contract'
...
export default {
  ...
  methods: {
    getContractDetailHandle () {
      contractDetail(this.$route.query.id).then(model => {
        model.actorType = model.actorType ? model.actorType.code : ''
        model.contractType = model.contractType ? model.contractType.code : ''
        model.paType = model.paType ? model.paType.code : ''
        model.signType = model.signType ? model.signType.code : ''
        model.tempType = model.tempType ? model.tempType.code : ''
