        ...
        <a-row :gutter="80">
          <a-col :md="8">
            <a-form-item
              class="form-item-flex"
              label="合同全文">
              <span style="padding-left:0;" v-if="contractConentUrl" class="file-name">{{ contractConentName }}</span>
          ...
          <a-col :md="8">
            <a-form-item
              class="form-item-flex"
              label="合同首页">
              <span style="padding-left:0;" class="file-name">{{ subStr(contractIndexPageUrl) }}</span>
          ...
          <a-col :md="8">
            <a-form-item
              class="form-item-flex"
              label="合同尾页">
              <span style="padding-left:0;" class="file-name">{{ subStr(contractLastPageUrl) }}</span>
...
export default {
  ...
  methods: {
    getContractDetailHandle () {
      extraContractDetail(this.contractId).then(model => {
