...
export default {
  ...
  data () {
    return {
      templateUrl: `${process.env.VUE_APP_API_BASE_URL}/wechat/info/download/operator/template`,
      uploadUrl: `${process.env.VUE_APP_API_BASE_URL}/wechat/info/import/info/operator`,
      errorUrl: `${process.env.VUE_APP_API_BASE_URL}/wechat/info/export/fail/operator`,
      errorDownUrl: '',
      loadding: false,
      success: false,
      fileInfo: {}
