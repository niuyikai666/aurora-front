  ...
  <a-card :bordered="false">
    <div class="sign-info-content">
      <a-form class="form" :form="form">
          ...
          <a-row class="sign-content">
            ...
            <a-col :xs="24" :md="8" v-if="form.getFieldValue('recruitType') === 0 || form.getFieldValue('recruitType') === 1">
              <a-form-item
                label="招募姓名">
                <search-employee
                  v-if="form.getFieldValue('recruitType')"
            ...
            <a-col :xs="24" :md="8" v-if="form.getFieldValue('lecturerType') === 1 || form.getFieldValue('lecturerType') === 2">
              <a-form-item
                ...
                <search-employee
                  ...
                  :searchFn="artistSearch"
                />
                <a-input placeholder="请输入讲师姓名" v-decorator="['lectureName',{rules: [{ required: true, message: '请输入讲师姓名'}]}]" v-else/>
              </a-form-item>
            </a-col>
            <a-col :xs="24" :md="8" v-if="form.getFieldValue('lecturerType') === 2">
              <a-form-item
                label="讲师手机号">
                <a-input placeholder="请输入讲师手机号" v-decorator="['lectureMobile',{rules: [{ required: true, message: '请输入正确讲师手机号', pattern: /^1[123456789]\d{9}$/}]}]" />
              </a-form-item>
            </a-col>
          </a-row>
        </tab-content>
        <tab-content title="身份信息" :titleLine="true">
          <a-row class="sign-content">
            <a-col :xs="24" :md="8">
              <a-form-item
                label="主播视频号ID">
                <a-input placeholder="请输入主播视频号ID" v-decorator="['platformCode',{rules: [{ required: true, message: '请输入主播视频号IDD'}]}]" />
              </a-form-item>
            </a-col>
            <a-col :xs="24" :md="8">
              <a-form-item
                label="主播视频号昵称">
                <a-input placeholder="请输入主播视频号昵称" v-decorator="['nickName',{rules: [{ required: true, message: '请输入主播视频号昵称'}]}]" />
              </a-form-item>
            </a-col>
            <a-col :xs="24" :md="8">
              <a-form-item
        ...
        <div class="btn-group">
          <a-button type="primary" icon="save" @click="handleSubmit" :loading="loading">保存信息</a-button>
        </div>
      </a-form>
    </div>
  </a-card>
...
import { agentSearch, artistSearch2, artistSearch } from '@/api/gold'
import { saveInfluecer, getPrefillInfluencerInfo } from '@/api/artists-video'
