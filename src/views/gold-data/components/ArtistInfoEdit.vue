      ...
      <tab-content title="签约信息" :titleLine="true">
        <a-row class="sign-content">
          ...
          <a-col :xs="24" :md="8">
            <a-form-item
              label="招募姓名">
              <a-input :disabled="signInfoDisabled" placeholder="请输入招募姓名" v-decorator="['recruitName',{rules: [{ required: true, message: '请输入招募姓名',pattern: /^(?=.*\S).+$/}]}]" v-if="showRecruitType!=1"/>
              <a-auto-complete
                :disabled="signInfoDisabled"
                style="width: 100%"
                placeholder="请选择招募人"
          ...
          <a-col :xs="24" :md="8" v-if="!showRecruitType">
            <a-form-item
              label="招募手机号">
              <a-input :disabled="signInfoDisabled" placeholder="请输入招募手机号" v-decorator="['recruitMobile',{rules: [{ required: false, message: '请输入正确招募手机号', pattern: /^1[123456789]\d{9}$/}]}]" />
            </a-form-item>
          </a-col>
          <a-col :xs="24" :md="8">
            <a-form-item
          ...
          <a-col :xs="24" :md="8" v-if="form.getFieldValue('isLecturerRecruit') !== 0">
            <a-form-item
              label="讲师姓名">
              <a-auto-complete
                style="width: 100%"
...
import { artistSearch2, artistSignSearch } from '@/api/gold'
