...
export default {
  ...
  data () {
    return {
      templateUrl: `${process.env.VUE_APP_API_BASE_URL}/wechat/info/download/administrator/template`,
      uploadUrl: `${process.env.VUE_APP_API_BASE_URL}/wechat/info/import/administrator`,
      errorUrl: `${process.env.VUE_APP_API_BASE_URL}/wechat/info/export/fail/administrator`,
      errorDownUrl: '',
      loadding: false,
      success: false,
      fileInfo: {}
